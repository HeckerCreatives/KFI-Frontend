...
import { Search01Icon, SearchingIcon } from 'hugeicons-react';
  ...
  return (
    <>
      ...
      <IonModal
        ...
        className=" [--border-radius:0.7rem] auto-height [--max-width:32rem] [--width:100%]"
      >
        {/* <IonHeader>
          <IonToolbar className=" text-white [--min-height:1rem] h-10 [---shadow:none]">
          ...
          <div className="relative overflow-auto">
            <Table>
              ...
              <TableBody>
                ...
                {!loading && data.expenseVouchers.length < 1 && <TableNoRows colspan={1} label="No expense voucher found" />}
                {!loading &&
