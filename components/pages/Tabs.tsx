...
export const navLinks: NavLink[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: "/dashboard/activity", label: "Activity Report", resource: "activity" },
  ...
  return (
    ...
    <FileQueue/>
      ...
      <IonPage id="main-content">
        ...
        >
          <div className='flex items-center justify-between max-w-[1920px] w-full gap-4 py-2 px-2'
          style={{
          ...
          >
            ...
            <div className="flex items-center justify-center py-1 rounded-md">
              <div className="flex items-center justify-center capitalize ">
                {/* <span className="hidden lg:flex text-[1rem] font-semibold">{token.username}</span> */}
                <IonButton
                  fill="clear"
                ...
                <IonContent class="[--padding-top:0.25rem] [--padding-bottom:0.25rem] !p-6 !rounded-xl">
                  ...
                  <div className=' w-full p-4 space-y-4'>
                    ...
                    {token.username.substring(0, 2)}
                      ...
                      <span className="hidden lg:flex text-[1rem] font-semibold capitalize">{token.username}</span>
                    </div>
