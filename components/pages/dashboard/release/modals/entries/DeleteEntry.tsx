...
import { AcknowledgementEntry, ReleaseEntry } from '../../../../../../types/types';
    ...
    <>
      ...
      >
        ...
        <div className="inner-content !p-6">
          <ModalHeader disabled={loading} title="Acknowledgement - Delete Entry" sub="Are you sure you want to delete this record?" dismiss={dismiss} />
