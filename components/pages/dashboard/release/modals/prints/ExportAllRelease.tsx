...
const ExportAllRelease = () => {
  ...
  return (
    <>
      <IonButton fill="clear" id="export_all_releases" className="h-10 bg-orange-50 text-orange-500 border border-orange-200 capitalize font-semibold rounded-xl" strong>
