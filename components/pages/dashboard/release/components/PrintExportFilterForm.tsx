        ...
        <div className="flex flex-col gap-1 flex-wrap">
          <div className="flex items-start gap-2">
            ...
            <div className="mt-1.5">
              <ReleaseSelection releaseLabel="docNoFromLabel" releaseValue="docNoFrom" clearErrors={form.clearErrors} setValue={form.setValue} />
            </div>
          </div>
          <div className="flex items-start gap-2">
            <div className="flex-1 relative">
            ...
            <div className="mt-1.5">
              <ReleaseSelection releaseLabel="docNoToLabel" releaseValue="docNoTo" clearErrors={form.clearErrors} setValue={form.setValue} />
            </div>
          </div>
        </div>
      </div>
