...
const PrintAllCenter = () => {
  ...
  setLoading(true);
  try {
    const result = await kfiAxios.get(`/center/print-all`, {
  ...
  return (
    <>
      <IonButton fill="clear" id="print_all_center" className="h-10 bg-orange-50 text-orange-500 border border-orange-200 capitalize font-semibold rounded-xl" strong>
