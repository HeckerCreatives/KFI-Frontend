...
import { LoanReleaseFilterFormData } from '../modals/PrintAllLoanRelease';
...
type PrintExportFilterFormProps = {
  loading: boolean;
  form: UseFormReturn<LoanReleaseFilterFormData>;
};
            ...
            <div className="flex-1 relative">
              <FormIonItem className="flex-1 min-w-64">
                <InputText
                  ...
                  readOnly
                  labelClassName="truncate min-w-10 !text-slate-600"
                />
              </FormIonItem>
