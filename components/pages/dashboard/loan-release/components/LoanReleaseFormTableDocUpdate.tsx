...
const LoanReleaseFormTableDocUpdate = ({ entry, index, remove, form, setPage, currentLength, sticky }: LoanReleaseFormTableDocProps) => {
...
export default LoanReleaseFormTableDocUpdate;
