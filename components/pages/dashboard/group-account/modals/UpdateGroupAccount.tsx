...
const UpdateGroupAccount = ({ index }: { index: number }) => {
  ...
  function onSubmit(data: GroupAccountFormData) {
    console.log(data);
  }
  ...
  return (
    <>
      <div className="text-end">
        <div
          id={`update-group-account-modal-${index}`}
      ...
      <IonModal
        ref={modal}
        trigger={`update-group-account-modal-${index}`}
