...
const StatementOfAccountReportFilter = () => {
  ...
  return (
    <div className="flex-1 flex flex-col md:flex-row flex-wrap items-start md:items-center justify-between ">
      <form onSubmit={form.handleSubmit(onSubmit)} className="w-full flex flex-col items-start justify-center gap-1">
        <FormIonItem className=" w-full max-w-[30rem]">
          <InputText
            name="acctOfficer"
...
export default StatementOfAccountReportFilter;
