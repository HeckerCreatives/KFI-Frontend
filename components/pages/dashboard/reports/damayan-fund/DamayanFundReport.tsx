...
import DfFilterByDate from './components/DfFilterByDate';
import DfFilterByDocNo from './components/DfFilterByDocNo';
import DfFilterByBank from './components/DfFilterByBank';
import DfFilterByAccount from './components/DfFilterByAccount';
import classNames from 'classnames';
import PageTitle from '../../../../ui/page/PageTitle';

const DamayanFundReport = () => {
    ...
    <IonPage className="">
      <IonContent className="[--background:#F1F1F1]" fullscreen>
        <div className="h-full flex flex-col items-stretch justify-start">
          <PageTitle pages={['Reports', 'Damayan Fund']} />
          <div className="px-3 pb-3">
            ...
            <div className="flex items-center justify-center gap-3 bg-white px-5 py-3 rounded-2xl shadow-lg mt-3 mb-4">
              {active === 'by-date' && <DfFilterByDate />}
              {active === 'by-doc-no' && <DfFilterByDocNo />}
              {active === 'by-account' && <DfFilterByAccount />}
              {active === 'by-bank' && <DfFilterByBank />}
            </div>
...
export default DamayanFundReport;
