    ...
    <div className="flex-1">
      <form onSubmit={form.handleSubmit(onSubmit)} className="w-full space-y-3">
        <FormIonItem className=" w-full max-w-[40rem]">
          <InputText name="bank" label="Bank" placeholder="Type here" control={form.control} clearErrors={form.clearErrors} className="!px-3 !py-1 !min-h-[1rem] rounded-md" />
        </FormIonItem>
        <FormIonItem className=" w-full max-w-[40rem]">
          <InputSelect
            name="option"
