...
import JvFilterByDate from './components/JvFilterByDate';
import JvFilterByDocNo from './components/JvFilterByDocNo';
import JvFilterByAccount from './components/JvFilterByAccount';
import JvFilterByBank from './components/JvFilterByBank';

const JournalVoucherReport = () => {
    ...
    <IonPage className="">
      <IonContent className="[--background:#F1F1F1]" fullscreen>
        <div className="h-full flex flex-col items-stretch justify-start">
          <PageTitle pages={['Reports', 'Journal Voucher']} />
          <div className="px-3 pb-3">
            ...
            <div className="flex items-center justify-center gap-3 bg-white px-5 py-3 rounded-2xl shadow-lg mt-3 mb-4">
              {active === 'by-date' && <JvFilterByDate />}
              {active === 'by-doc-no' && <JvFilterByDocNo />}
              {active === 'by-account' && <JvFilterByAccount />}
              {active === 'by-bank' && <JvFilterByBank />}
            </div>
