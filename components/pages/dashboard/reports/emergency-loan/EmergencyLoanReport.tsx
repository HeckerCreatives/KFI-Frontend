...
import ElFilterByDate from './components/ElFilterByDate';
import ElFilterByDocNo from './components/ElFilterByDocNo';
import ElFilterByAccount from './components/ElFilterByAccount';
import ElFilterByBank from './components/ElFilterByBank';
    ...
    <IonPage className="">
      <IonContent className="[--background:#F1F1F1]" fullscreen>
        <div className="h-full flex flex-col items-stretch justify-start">
          <PageTitle pages={['Reports', 'Emergency Loan']} />
          <div className="px-3 pb-3">
            ...
            <div className="flex items-center justify-center gap-3 bg-white px-5 py-3 rounded-2xl shadow-lg mt-3 mb-4">
              {active === 'by-date' && <ElFilterByDate />}
              {active === 'by-doc-no' && <ElFilterByDocNo />}
              {active === 'by-account' && <ElFilterByAccount />}
              {active === 'by-bank' && <ElFilterByBank />}
            </div>
