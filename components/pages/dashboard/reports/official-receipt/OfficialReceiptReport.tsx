...
import OrFilterByDate from './components/OrFilterByDate';
import OrFilterByDocNo from './components/OrFilterByDocNo';
import OrFilterByAccount from './components/OrFilterByAccount';
import OrFilterByBank from './components/OrFilterByBank';
import classNames from 'classnames';
import PageTitle from '../../../../ui/page/PageTitle';

const OfficialReceiptReport = () => {
    ...
    <IonPage className="">
      <IonContent className="[--background:#F1F1F1]" fullscreen>
        <div className="h-full flex flex-col items-stretch justify-start">
          <PageTitle pages={['Reports', 'Official Receipt']} />
          <div className="px-3 pb-3">
            ...
            <div className="flex items-center justify-center gap-3 bg-white px-5 py-3 rounded-2xl shadow-lg mt-3 mb-4">
              {active === 'by-date' && <OrFilterByDate />}
              {active === 'by-doc-no' && <OrFilterByDocNo />}
              {active === 'by-account' && <OrFilterByAccount />}
              {active === 'by-bank' && <OrFilterByBank />}
            </div>
...
export default OfficialReceiptReport;
