...
const DashboardCard = ({ title, icon, value, loading = false, details = false }: DashboardCardProps) => {
  return (
    <div className=" relative shadow-sm max-w-[450px] h-[140px] bg-white p-6 flex-1 min-w-56 rounded-xl flex items-start justify-between overflow-hidden">
      ...
      <div className=" relative z-10 space-y-2">
        <div className="text-[0.8rem] !font-semibold truncate text-orange-300 ">{title}</div>
      ...
      <div className=' flex flex-col items-end justify-between gap-6 relative z-30'>
        <div className=" relative z-10 bg-orange-50 w-10 h-10 rounded-xl backdrop-blur-lg flex items-center justify-center text-orange-500">
        {icon}
        </div>
