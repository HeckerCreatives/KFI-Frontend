...
import { cashOutline, personAddOutline, personCircleOutline, personCircleSharp, personOutline, personRemoveOutline } from 'ionicons/icons';
              ...
              <IonRow>
                <IonCol size="12" sizeMd="8">
                  ...
                  <div className="flex flex-wrap items-center justify-around gap-2">
                    <div className="shadow-lg bg-white p-4 flex-1 rounded-sm">
                      <div className="flex items-center justify-between">
                        <div className="text-[1rem] font-semibold text-slate-600 tracking-wider truncate">Total Active Members</div>
                        <div className="min-w-6 min-h-6 p-2 grid place-items-center rounded-full bg-green-100">
                          <IonIcon icon={personAddOutline} className="text-green-800 min-w-5 max-w-5 max-h-5 min-h-5" />
                        </div>
                      </div>
                      <div className="text-3xl my-3 text-slate-600 font-semibold tracking-widest">9,999,999</div>
                    </div>
                    <div className="shadow-lg bg-white p-4 flex-1 rounded-sm">
                      <div className="flex items-center justify-between">
                        <div className="text-[1rem] font-semibold text-slate-600 tracking-wider truncate">Total Inactive Members</div>
                        <div className="min-w-6 min-h-6 p-2 grid place-items-center rounded-full bg-red-100">
                    ...
                    <div className="shadow-lg bg-white p-4 flex-1 rounded-sm">
                      <div className="flex items-center justify-between">
                        <div className="text-[1rem] font-semibold text-slate-600 tracking-wider truncate">Total Loan Amount</div>
                        <div className="min-w-6 min-h-6 p-2 grid place-items-center rounded-full bg-orange-100">
                  ...
                  {/* Table */}
                  <div className="bg-white shadow-lg rounded-sm px-3 pt-1 pb-2 mt-2">
                        ...
                        <TableBody>
                          {arrDummy.map((arr: string, i: number) => (
                            <TableRow key={i} className="!border-0 odd:bg-orange-50">
                              ...
                              <TableCell className="">Binangonan</TableCell>
                              <TableCell className="">523</TableCell>
                              <TableCell className="">5,000,000</TableCell>
                            </TableRow>
                          ))}
                        </TableBody>
                      </Table>
                ...
                <IonCol size="12" sizeMd="4">
                  <div className="flex flex-col flex-wrap h-full items-start gap-2 justify-center">
