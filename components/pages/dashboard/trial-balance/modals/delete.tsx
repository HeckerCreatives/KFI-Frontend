...
const DeleteTB = ({item,getList,currentPage }: DeleteNatureProps) => {
  ...
  async function handleDelete() {
     ...
     if(online){
       try {
        const result = await kfiAxios.delete(`/trial-balance/${item._id}`);
       ...
       if (item._id) {
                       ...
                       await db.trialBalance.update(item.id, {
    ...
    <>
      ...
      >
         <div className="p-6 flex flex-col gap-6">
           <ModalHeader disabled={loading} title="Trial Balance - Delete Record" sub="Are you sure you want to delete this record?" dismiss={dismiss} />
