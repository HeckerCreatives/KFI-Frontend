...
const DeleteBusinessType = ({ businessType, getBusinessTypes, searchkey, sortKey, currentPage, rowLength }: DeleteLoanProps) => {
  ...
  return (
    <>
      {/* <div className="text-end">
        <div
          id={`delete-businessType-modal-${businessType._id}`}
      ...
      <IonModal
        ref={modal}
        trigger={`delete-businessType-modal-${businessType._id}`}
      ...
      >
        {/* <IonHeader>
          <IonToolbar className=" text-white [--min-height:1rem] h-12">
            <ModalHeader disabled={loading} title="Business type - Delete Record" sub="System" dismiss={dismiss} />
          </IonToolbar>
        </IonHeader> */}
        <div className="inner-content !p-6">
            <ModalHeader disabled={loading} title="Business type - Delete Record" sub="Are you sure you want to delete this record?" dismiss={dismiss} />
