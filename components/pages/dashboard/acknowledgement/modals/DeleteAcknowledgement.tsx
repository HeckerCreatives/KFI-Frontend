...
const DeleteAcknowledgement = ({ acknowledgement, getAcknowledgements, searchkey, sortKey, rowLength, currentPage }: DeleteAcknowledgementProps) => {
    ...
    <>
      ...
      >
        ...
        <div className="inner-content !p-6">
            <ModalHeader disabled={loading} title="Official Receipt - Delete Record" sub="Are you sure you want to delete this record?" dismiss={dismiss} />
...
export default DeleteAcknowledgement;
