...
const PrintAllJournalVoucher = () => {
        ...
        const blob = new Blob([result.data])  
         ...
         const fileURL = URL.createObjectURL(blob);
          addJob({
            ...
            label: `Journal Voucher ${tabActive}`,
            type: 'print',
            progress: 100,
            status: 'processing',
            fileType: 'pdf',
  ...
  return (
    <>
      <IonButton fill="clear" id="print_all_journal_voucher" className="h-10 bg-orange-50 text-orange-500 border border-orange-200 capitalize font-semibold rounded-xl" strong>
