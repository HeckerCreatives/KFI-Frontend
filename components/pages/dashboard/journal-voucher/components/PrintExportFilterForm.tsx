...
import { JournalVoucherFilterFormData } from '../modals/prints/PrintAllJournalVoucher';
import { DocumentAttachmentIcon } from 'hugeicons-react';

type PrintExportFilterFormProps = {
  loading: boolean;
  form: UseFormReturn<JournalVoucherFilterFormData>;
};
  ...
  return (
    <div className="space-y-1">
      <div className="border p-3 rounded-md border-slate-300">
        <h6 className="m-0 mb-2 !font-semibold text-sm flex items-center gap-1">
          <DocumentAttachmentIcon size={25} stroke='.8' className=' p-1 bg-green-50 rounded-md text-green-600'/>
          Document No.</h6>
        <div className="flex flex-col gap-1 flex-wrap">
          <div className="flex items-end gap-2">
            ...
            <div className="mb-1.5">
              <JournalVoucherSelection journalVoucherLabel="docNoFromLabel" journalVoucherValue="docNoFrom" clearErrors={form.clearErrors} setValue={form.setValue} />
            </div>
          </div>
          <div className="flex items-end gap-2">
            <div className="flex-1 relative">
            ...
            <div className="mb-1.5">
              <JournalVoucherSelection journalVoucherLabel="docNoToLabel" journalVoucherValue="docNoTo" clearErrors={form.clearErrors} setValue={form.setValue} />
            </div>
          </div>
        </div>
      </div>
      <div className="border p-3 rounded-md border-slate-300">
        <p className=" mb-2 !font-semibold text-sm">Options</p>
        <InputRadio
          control={form.control}
          name="option"
          clearErrors={form.clearErrors}
