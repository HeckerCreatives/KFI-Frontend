...
import CreateOfficialReceipt from './modals/CreateOfficialReceipt';
import OfficialReceiptFilter from './components/OfficialReceiptFilter';
import OfficialReceiptActions from './components/OfficialReceiptActions';
                ...
                <TableBody>
                  {arrDummy.map((arr: string, i: number) => (
                    <TableRow key={i}>
                      ...
                      <TableCell>
                        <OfficialReceiptActions index={i} />
                      </TableCell>
                    </TableRow>
                  ))}
                </TableBody>
