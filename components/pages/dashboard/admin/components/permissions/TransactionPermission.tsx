...
import { transactionResource } from '../../../../../utils/constants';
import UserTableRow from '../UserTableRow';

const TransactionPermission = ({ permissions, setPermissions }: { permissions: Permission[]; setPermissions: React.Dispatch<React.SetStateAction<Permission[]>> }) => {
  return (
    <div>
      <h6 className="!font-medium m-0 mt-2">Transactions</h6>
