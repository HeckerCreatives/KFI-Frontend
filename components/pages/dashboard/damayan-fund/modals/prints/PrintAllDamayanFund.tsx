...
const PrintAllDamayanFund = () => {
  ...
  async function handlePrint(data: DamayanFundFilterFormData) {
    try {
      ...
      setLoading(true);
      const result = await kfiAxios.get(`/damayan-fund/print-all/${data.option}`, { params: params, responseType: 'blob' });
    ...
    <>
      ...
      >
        ...
        <div className="inner-content !p-6">
            <ModalHeader disabled={loading} title="Damayan Fund - Print All" sub="Manage damayan fund records." dismiss={dismiss} />
...
export default PrintAllDamayanFund;
