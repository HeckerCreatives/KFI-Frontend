...
const ExportAllDamayanFund = () => {
      ...
      if(contentType.includes('vnd.openxmlformats-officedocument.spreadsheetml.sheet')){
              const fileURL = URL.createObjectURL(blob);
               addJob({
                 ...
                 fileType: 'excel',
                 file: '',
                 filename: `damayan-fund-${tabActive}.xlsx`,
                 fileUrl: fileURL
               })
            } else {
             const fileURL = URL.createObjectURL(blob);
 ...
 const message = data.message.toLowerCase();
  ...
  return (
    <>
      <IonButton fill="clear" id="export_all_damayan_fund" className="h-10 bg-orange-50 text-orange-500 border border-orange-200 capitalize font-semibold rounded-xl" strong>
