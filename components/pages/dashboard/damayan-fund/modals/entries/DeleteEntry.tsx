...
import { DamayanFundEntry } from '../../../../../../types/types';
...
const DeleteEntry = ({ entry, getEntries, rowLength, currentPage, setEntries, setData, setDeletedIds }: DeleteEntryProps) => {
  ...
  const handleDelete = async () => {
         ...
         try {
           setData((prev: TDFData) => {
             ...
             return {
               ...prev,
               entries: prev.entries.filter((e: DamayanFundEntry) => e._id !== entry._id),
             };
           });
      ...
      >
        {/* <IonHeader>
          <IonToolbar className=" text-white [--min-height:1rem] h-12">
            <ModalHeader disabled={loading} title="Damayan Fund - Delete Entry" sub="Transaction" dismiss={dismiss} />
          </IonToolbar>
        </IonHeader> */}
        <div className="inner-content !p-6">
            <ModalHeader disabled={loading} title="Damayan Fund - Delete Entry" sub="Are you sure you want to delete this record?" dismiss={dismiss} />
