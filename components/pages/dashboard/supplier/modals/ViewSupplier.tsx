      ...
      >
        ...
        <div className="inner-content space-y-2">
          <div className="w-full flex items-start gap-2 text-slate-600">
            ...
            <div className={classNames('border border-slate-400 min-h-8 text-[0.7rem] py-0 px-3 text-sm flex items-center flex-1 rounded-md capitalize')}>{supplier.code}</div>
          </div>
          <div className="w-full flex items-start gap-2 text-slate-600">
            <div className={classNames('text-slate-600 text-[0.85rem]  font-semibold truncate w-fit min-w-20 text-end')}>Description</div>
            <div className={classNames('border border-slate-400 min-h-8 text-[0.7rem] py-0 px-3 text-sm flex items-center flex-1 rounded-md capitalize')}>
