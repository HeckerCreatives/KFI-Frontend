  ...
  return (
    <>
      <div className="text-end">
        <IonButton fill="clear" id="create-supplier-modal" className="max-h-10 min-h-6 bg-[#FA6C2F] text-white capitalize font-semibold rounded-md" strong>
          + Add Record
        </IonButton>
      </div>
      <IonModal
      ...
      >
        ...
        <div className="inner-content !p-6">
            <ModalHeader disabled={loading} title="Supplier - Add Record" sub="Manage supplier records." dismiss={dismiss} />

          <div>
            <form onSubmit={form.handleSubmit(onSubmit)} className=' mt-4'>
              <SupplierForm form={form} loading={loading} />
