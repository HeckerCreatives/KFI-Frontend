...
const DeleteExpenseVoucher = ({ expenseVoucher, getExpenseVouchers, searchkey, sortKey, rowLength, currentPage }: DeleteExpenseVoucherProps) => {
      ...
      >
        {/* <IonHeader>
          <IonToolbar className=" text-white [--min-height:1rem] h-12">
            <ModalHeader disabled={loading} title="Expense Voucher - Delete Record" sub="Transaction" dismiss={dismiss} />
          </IonToolbar>
        </IonHeader> */}
        <div className="inner-content !p-6">
            <ModalHeader disabled={loading} title="Expense Voucher - Delete Record" sub="Are you sure you want to delete this record?" dismiss={dismiss} />
