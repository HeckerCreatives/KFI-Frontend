...
const DeleteEntry = ({ entry, getEntries, rowLength, currentPage, setEntries, setDeletedIds, setData }: DeleteEntryProps) => {
    ...
    <>
      ...
      >
        ...
        <div className="inner-content !p-6">
            ...
            <ModalHeader disabled={loading} title="Expense Voucher - Delete Entry" sub="Are you sure you want to delete this record?" dismiss={dismiss} />
