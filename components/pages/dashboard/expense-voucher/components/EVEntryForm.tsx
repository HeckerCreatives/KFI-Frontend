...
import { ExpenseVoucherEntryFormData } from '../../../../../validations/expense-voucher.schema';

type TForm = {
  form: UseFormReturn<ExpenseVoucherEntryFormData>;
  loading?: boolean;
};

const EntryForm = ({ form, loading = false }: TForm) => {
  const clearAcctCode = () => {
