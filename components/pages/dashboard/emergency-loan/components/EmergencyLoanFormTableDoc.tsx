...
type EmergencyLoanFormTableDocProps = {
  entry: EmergencyLoanEntryFormData;
  index: number;
...
const EmergencyLoanFormTableDoc = ({ entry, index, remove, form, sticky }: EmergencyLoanFormTableDocProps) => {
...
export default EmergencyLoanFormTableDoc;
