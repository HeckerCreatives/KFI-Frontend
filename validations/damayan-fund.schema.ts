...
export const damayanFundSchema = z
  .object({
    code: z.string().min(1, 'JV # is required'),
...
export type DamayanFundFormData = z.infer<typeof damayanFundSchema>;
export type DamayanFundEntryFormData = z.infer<typeof damayanFundEntrySchema>;
